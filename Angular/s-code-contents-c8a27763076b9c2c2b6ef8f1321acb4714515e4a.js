var s_account = "hkexpress-web-dev"

if(document.domain=="www.hkexpress.com" || document.domain=="hkexpress.com" || document.domain=="booking.hkexpress.com" || document.domain=="www.hongkongexpress.com" || document.domain=="flyhkexpress.com" || document.domain=="www.flyhkexpress.com" || document.domain=="careers.hkexpress.com" )
{
	var s_account = "hkexpress-web-prd"
} 
...
s.linkInternalFilters="javascript:,hkexpress.com,flyhkexpress.com,hongkongexpress.com"
...
if(sitedomain=="hkexpress.com"){
    sitedomain="www.hkexpress.com";
}
s.siteID = s.server = sitedomain
...
function s_doPlugins(s) {
    ...
    if(!s.pageType && !s.pageName)s.pageName=unescape(s.getPageName().toLowerCase());
	s.temp = s.pageName.substr(0, s.pageName.lastIndexOf('/'));
	/* if no site sections are defined on page, set based on folder structure*/
    s.prop1=s.temp.split('/')[1];//level 1
	s.prop2=s.channel=s.temp.split('/')[2];//level 2
	s.prop3=s.temp.split('/')[3];//level 3
    ...
    s.eVar2=s.campaign=s.Util.getQueryParam('utm_campaign');
    s.eVar3=s.Util.getQueryParam('utm_medium');
	var time = new Date();
	 s.prop5=("0" + time.getHours()).slice(-2)   + ":" + ("0" + time.getMinutes()).slice(-2)
...
s.visitorNamespace = "hkexpress"
s.trackingServer = "hkexpress.sc.omtrdc.net";
